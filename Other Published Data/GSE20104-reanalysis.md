...
output_file <- 'GSE20104 Analysis.tsv'
...
|GO:0033139 |  2.00|  0.000|    0.027|regulation of peptidyl-serine phosphorylation of STAT protein                        |Ifnz/Ifna14/Gadd45a/Ifna13/Ifna2/Ifnb1/Ifna11/Ifna9/Ifna12/Gfra2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
|GO:0071294 |  1.96|  0.001|    0.044|cellular response to zinc ion                                                        |Mt1/Gabrb3/Glra2/Gpr39/Mt4/Mt3                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
|GO:0034101 | -1.69|  0.000|    0.027|erythrocyte homeostasis                                                              |Pla2g10/Exoc6/Sp3/Rhag/Rps24/Ncor1/Cdk5rap3/Lyn/Bcl6/Id2/Ptpn2/Tmod3/Acvr2a/Sfxn1/Zbtb7a/Sox6/Epas1/Sp1/B2m/Stat5b/Alas2/Hoxa5/Stat3/Acvr1b/Cd24a/Hspa1a/Jak2/Prdx1/G6pd2/Stat1/Hbb-b1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
|:----------|-----:|-----:|-------:|-----:|----:|----:|:------------|
|ATF4p0.001 | 0.000| 0.000|   0.611| 0.855| 2.06|   15|Uchl1, S.... |
|ATF4p0.01  | 0.000| 0.000|   0.675| 0.612| 2.04|   86|Uchl1, S.... |
|ATF4q0.25  | 0.001| 0.001|   0.455| 0.862| 1.80|    8|Uchl1, A.... |
|ATF4p0.05  | 0.000| 0.000|   0.557| 0.401| 1.53|  410|Uchl1, S.... |
...
|GO:0003015 |7/119     |  0.000|    0.005|heart process                                                                           |
...
|GO:0043502 |4/119     |  0.001|    0.022|regulation of muscle adaptation                                                         |
...
|GO:0005976 |4/119     |  0.001|    0.026|polysaccharide metabolic process                                                        |
...
```r
genes.to.test <- c('Sln','Gdf15','Atp2a2', 'Tnni1')
kt.id <- tT2 %>% filter(Gene.symbol%in%genes.to.test) %>% rownames()
kt.exprs <- exprs(gset)[kt.id,] 
rownames(kt.exprs) <- tT2[kt.id,'Gene.symbol']

library(tibble)
kt.data <- as.data.frame(kt.exprs) %>%
  rownames_to_column(var="Gene") %>%
  pivot_longer(-Gene, names_to='Sample') %>%
  mutate(Treatment=rep(as.character(gs),dim(kt.exprs)[1]))


library(forcats)
kt.data %>%
  group_by(Gene,Treatment) %>%
  summarize(avg=mean(2^value),
            error=se(2^value)) %>% 
  mutate(norm.mean = avg/avg[Treatment=='Control'],
         norm.error = error/avg[Treatment=='Control']) %>%
  mutate(Treatment=fct_recode(as.factor(relevel(as.factor(Treatment),ref="Control")),
                              "Empty Vector"="Control",
                              "ATF4 Overexpression"="ATF4.OE")) %>%
  ggplot(aes(x=Gene,
             fill=Treatment,
             y=norm.mean,
             ymin=norm.mean-norm.error,
  ...
  #scale_x_discrete(labels=c("Control" = "Empty Vector", "ATF4 Overexpression" = "ATF4")) +
  theme_classic() +
  ...
  labs(y='Relative mRNA Expression',
       x='',
       title='Effects ATF4 Overexpression on \nTsc1-Knockout Induced Genes')
```

![](figures/atf4-tsc-barplot-1.png)<!-- -->


```r
genes.to.test <- c('Slc16a1','Oxct1','Hmgcs2')
kt.id <- tT2 %>% filter(Gene.symbol%in%genes.to.test) %>% rownames()
kt.exprs <- exprs(gset)[kt.id,] 
...
![](figures/atf4-ketolytic-barplot-1.png)<!-- -->
...
##  [1] tibble_3.2.1              forcats_1.0.0            
##  [3] fgsea_1.24.0              enrichplot_1.18.4        
##  [5] org.Mm.eg.db_3.15.0       AnnotationDbi_1.60.2     
##  [7] IRanges_2.32.0            S4Vectors_0.36.2         
##  [9] clusterProfiler_4.9.0.002 venneuler_1.1-3          
## [11] rJava_1.0-6               ggplot2_3.4.2            
## [13] maptools_1.1-7            sp_1.6-1                 
## [15] umap_0.2.10.0             limma_3.52.4             
## [17] GEOquery_2.64.2           Biobase_2.58.0           
## [19] BiocGenerics_0.44.0       broom_1.0.4              
## [21] dplyr_1.1.2               tidyr_1.3.0              
## [23] knitr_1.43               
## 
## loaded via a namespace (and not attached):
##   [1] shadowtext_0.1.2       backports_1.4.1        fastmatch_1.1-3       
##   [4] plyr_1.8.8             igraph_1.4.3           lazyeval_0.2.2        
##   [7] splines_4.2.2          BiocParallel_1.32.6    GenomeInfoDb_1.34.9   
...
##  [19] tzdb_0.4.0             Biostrings_2.66.0      readr_2.1.4           
##  [22] graphlayouts_1.0.0     R.utils_2.12.2         askpass_1.1           
##  [25] colorspace_2.1-0       blob_1.2.4             ggrepel_0.9.3         
##  [28] xfun_0.39              crayon_1.5.2           RCurl_1.98-1.12       
##  [31] jsonlite_1.8.5         scatterpie_0.2.1       ape_5.7-1             
##  [34] glue_1.6.2             polyclip_1.10-4        gtable_0.3.3          
##  [37] zlibbioc_1.44.0        XVector_0.38.0         scales_1.2.1          
##  [40] DOSE_3.24.2            DBI_1.1.3              Rcpp_1.0.10           
##  [43] viridisLite_0.4.2      gridGraphics_0.5-1     tidytree_0.4.2        
##  [46] reticulate_1.29        foreign_0.8-84         bit_4.0.5             
##  [49] httr_1.4.6             RColorBrewer_1.1-3     pkgconfig_2.0.3       
##  [52] R.methodsS3_1.8.2      farver_2.1.1           sass_0.4.6            
##  [55] utf8_1.2.3             ggplotify_0.1.0        tidyselect_1.2.0      
##  [58] labeling_0.4.2         rlang_1.1.1            reshape2_1.4.4        
##  [61] munsell_0.5.0          tools_4.2.2            cachem_1.0.8          
##  [64] downloader_0.4         cli_3.6.1              generics_0.1.3        
##  [67] RSQLite_2.3.1          gson_0.1.0             evaluate_0.21         
##  [70] stringr_1.5.0          fastmap_1.1.1          yaml_2.3.7            
##  [73] ggtree_3.6.2           fs_1.6.2               bit64_4.0.5           
##  [76] tidygraph_1.2.3        purrr_1.0.1            KEGGREST_1.38.0       
##  [79] ggraph_2.1.0           nlme_3.1-162           R.oo_1.25.0           
##  [82] aplot_0.1.10           xml2_1.3.4             compiler_4.2.2        
##  [85] rstudioapi_0.14        curl_5.0.1             png_0.1-8             
##  [88] treeio_1.22.0          tweenr_2.0.2           bslib_0.4.2           
##  [91] stringi_1.7.12         highr_0.10             RSpectra_0.16-1       
##  [94] lattice_0.21-8         Matrix_1.5-4.1         vctrs_0.6.2           
##  [97] pillar_1.9.0           lifecycle_1.0.3        jquerylib_0.1.4       
## [100] data.table_1.14.8      cowplot_1.1.1          bitops_1.0-7          
## [103] patchwork_1.1.2        qvalue_2.30.0          R6_2.5.1              
## [106] gridExtra_2.3          codetools_0.2-19       MASS_7.3-60           
## [109] openssl_2.0.6          withr_2.5.0            GenomeInfoDbData_1.2.9
## [112] mgcv_1.8-42            parallel_4.2.2         hms_1.1.3             
## [115] ggupset_0.3.0          grid_4.2.2             ggfun_0.0.9           
## [118] HDO.db_0.99.1          rmarkdown_2.22         ggnewscale_0.4.9      
## [121] ggforce_0.4.1
```
