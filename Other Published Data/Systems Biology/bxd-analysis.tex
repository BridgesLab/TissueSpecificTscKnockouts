...
\midrule
\endhead
Name & 43 & 1.547 & 0.036 & 22 & 0 & 0.038 & 95.66\tabularnewline
Residuals & 148 & 0.242 & 0.002 & NA & NA & 0.038 & 4.34\tabularnewline
\bottomrule
\end{longtable}
...
\midrule
\endhead
Lean & 1 & 0.207 & 0.207 & 127.8 & 0 & 0.24 & 86.303\tabularnewline
Name & 43 & 1.343 & 0.031 & 19.3 & 0 & 0.24 & 13.021\tabularnewline
Residuals & 147 & 0.238 & 0.002 & NA & NA & 0.24 & 0.676\tabularnewline
\bottomrule
\end{longtable}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Total.Var=}\KeywordTok{sum}\NormalTok{(meansq[}\DecValTok{2}\OperatorTok{:}\DecValTok{3}\NormalTok{]),}
         \DataTypeTok{Pct.Var =}\NormalTok{ meansq}\OperatorTok{/}\NormalTok{Total.Var}\OperatorTok{*}\DecValTok{100}\NormalTok{) ->}\StringTok{ }\NormalTok{lean.adj.ee}
  
\NormalTok{lean.adj.ee }\OperatorTok{%>%}\StringTok{ }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{caption=}\StringTok{"Overall heritability of energy expenditure on NCD adjusting for lean mass"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\midrule
\endhead
Lean & 1 & 0.207 & 0.207 & 127.8 & 0 & 0.033 & 630.08\tabularnewline
Name & 43 & 1.343 & 0.031 & 19.3 & 0 & 0.033 & 95.07\tabularnewline
Residuals & 147 & 0.238 & 0.002 & NA & NA & 0.033 & 4.93\tabularnewline
\bottomrule
\end{longtable}
...
\midrule
\endhead
Lean & 1 & 0.697 & 0.697 & 260.67 & 0 & 3.39 & 20.577\tabularnewline
Name & 43 & 2.296 & 0.053 & 19.98 & 0 & 3.39 & 1.577\tabularnewline
Diet & 1 & 2.624 & 2.624 & 981.81 & 0 & 3.39 & 77.503\tabularnewline
Name:Diet & 42 & 0.375 & 0.009 & 3.34 & 0 & 3.39 & 0.264\tabularnewline
Residuals & 291 & 0.778 & 0.003 & NA & NA & 3.39 & 0.079\tabularnewline
\bottomrule
\end{longtable}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Total.Var=}\KeywordTok{sum}\NormalTok{(meansq[}\KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{4}\NormalTok{,}\DecValTok{5}\NormalTok{)]),}
         \DataTypeTok{Pct.Var =}\NormalTok{ meansq}\OperatorTok{/}\NormalTok{Total.Var}\OperatorTok{*}\DecValTok{100}\NormalTok{) ->}\StringTok{ }\NormalTok{hfd.adj.ee}

\NormalTok{hfd.adj.ee }\OperatorTok{%>%}\StringTok{ }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{caption=}\StringTok{"Overall heritability of energy expenditure adjusted for diet and lean mass"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\midrule
\endhead
Lean & 1 & 0.697 & 0.697 & 260.67 & 0 & 0.065 & 1071.68\tabularnewline
Name & 43 & 2.296 & 0.053 & 19.98 & 0 & 0.065 & 82.14\tabularnewline
Diet & 1 & 2.624 & 2.624 & 981.81 & 0 & 0.065 & 4036.53\tabularnewline
Name:Diet & 42 & 0.375 & 0.009 & 3.34 & 0 & 0.065 & 13.74\tabularnewline
Residuals & 291 & 0.778 & 0.003 & NA & NA & 0.065 & 4.11\tabularnewline
\bottomrule
\end{longtable}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ee.var.data <-}\StringTok{ }\KeywordTok{bind_rows}\NormalTok{(lean.adj.ee }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Diet=}\StringTok{"NCD"}\NormalTok{),hfd.adj.ee }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Diet=}\StringTok{"HFD"}\NormalTok{)) }
...
\StringTok{  }\KeywordTok{scale_fill_manual}\NormalTok{(}\DataTypeTok{labels =} \KeywordTok{c}\NormalTok{(}\StringTok{"Gene"}\NormalTok{, }\StringTok{"Gene x Diet"}\NormalTok{, }\StringTok{"Other"}\NormalTok{), }\DataTypeTok{values =} \KeywordTok{c}\NormalTok{(}\StringTok{"red"}\NormalTok{, }\StringTok{"pink"}\NormalTok{,}\StringTok{"blue"}\NormalTok{),}
