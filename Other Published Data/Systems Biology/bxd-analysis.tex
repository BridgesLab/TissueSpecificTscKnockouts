...
\StringTok{  }\KeywordTok{select}\NormalTok{(Value_lm,Value_bw, MR_W, MR_W_SE, MR_adj,Name,Diet) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{pivot_wider}\NormalTok{(}\DataTypeTok{names_from=}\NormalTok{Diet,}\DataTypeTok{id_cols=}\NormalTok{Name,}\DataTypeTok{values_from=}\KeywordTok{c}\NormalTok{(Value_lm,Value_bw, MR_W,MR_W_SE,MR_adj)) }\OperatorTok{%>%}
...
\midrule
\endhead
Name & 43 & 1.431 & 0.033 & 16.9 & 0 & 0.035 & 94.43\tabularnewline
Residuals & 148 & 0.291 & 0.002 & NA & NA & 0.035 & 5.57\tabularnewline
\bottomrule
\end{longtable}
...
\midrule
\endhead
Lean & 1 & 0.102 & 0.102 & 53.1 & 0 & 0.135 & 75.64\tabularnewline
Name & 43 & 1.335 & 0.031 & 16.1 & 0 & 0.135 & 22.93\tabularnewline
Residuals & 147 & 0.283 & 0.002 & NA & NA & 0.135 & 1.42\tabularnewline
\bottomrule
\end{longtable}
...
\midrule
\endhead
Lean & 1 & 0.102 & 0.102 & 53.1 & 0 & 0.033 & 310.59\tabularnewline
Name & 43 & 1.335 & 0.031 & 16.1 & 0 & 0.033 & 94.16\tabularnewline
Residuals & 147 & 0.283 & 0.002 & NA & NA & 0.033 & 5.84\tabularnewline
\bottomrule
\end{longtable}
...
\midrule
\endhead
Lean & 1 & 0.718 & 0.718 & 236.47 & 0 & 3.48 & 20.620\tabularnewline
Name & 43 & 2.201 & 0.051 & 16.87 & 0 & 3.48 & 1.471\tabularnewline
Diet & 1 & 2.700 & 2.700 & 889.77 & 0 & 3.48 & 77.589\tabularnewline
Name:Diet & 42 & 0.341 & 0.008 & 2.68 & 0 & 3.48 & 0.234\tabularnewline
Residuals & 291 & 0.883 & 0.003 & NA & NA & 3.48 & 0.087\tabularnewline
\bottomrule
\end{longtable}
...
\midrule
\endhead
Lean & 1 & 0.718 & 0.718 & 236.47 & 0 & 0.062 & 1150.91\tabularnewline
Name & 43 & 2.201 & 0.051 & 16.87 & 0 & 0.062 & 82.09\tabularnewline
Diet & 1 & 2.700 & 2.700 & 889.77 & 0 & 0.062 & 4330.66\tabularnewline
Name:Diet & 42 & 0.341 & 0.008 & 2.68 & 0 & 0.062 & 13.04\tabularnewline
Residuals & 291 & 0.883 & 0.003 & NA & NA & 0.062 & 4.87\tabularnewline
\bottomrule
\end{longtable}
...
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{y=}\StringTok{"Percent of Variance"}\NormalTok{,}
       \DataTypeTok{x=}\StringTok{"Group - Adjustments"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_classic}\NormalTok{() }\OperatorTok{+}
