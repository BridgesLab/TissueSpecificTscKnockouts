...
williams.ncd.ee <- read_csv("BXD_17622.csv", skip=9)%>% #may be mislabelled on genenetwork, assigned based on HFD reductions
...
williams.hfd.ee <- read_csv("BXD_17618.csv" , skip=9)%>% #may be mislabelled on genenetwork
