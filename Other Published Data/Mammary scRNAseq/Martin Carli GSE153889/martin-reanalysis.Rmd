...
prop.table(table(Idents(martin.dataset))) %>% kable(caption="Cell proportions in each cluster")
```
,
...
milk.fat.globules <- c('Pas3','Sluc1','Btn1a1','Pas7','Muc1','Plin2','Xdh') %>% toupper
