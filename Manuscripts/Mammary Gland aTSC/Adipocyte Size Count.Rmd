...
#graphing normalized adipocyte count
  ggplot(adipocyte.number,
         aes(x=Genotype,
           y= adipocytesperarea,
           fill=Genotype))   + 
  ...
  theme(legend.position = "none")+
    labs(y="Adipocyte Count Normalized to MG Area",
         x="Maternal Genotype")
...
#graphing normalized adipocyte percent of total MG area
  ggplot(adipocyte.percent,
         aes(x=Genotype,
           y= normalizedadipocytesarea,
           fill=Genotype))   + 
      geom_bar(stat='identity', position="dodge") +
  expand_limits(y=0) +
  theme_classic() +
...
ggplot(data=percentileareabymouse, 
  ...
  theme_classic() + 
    ...
    theme(text=element_text(size=18),
          axis.text.x = element_text(angle=90,vjust = 0.5, hjust=0.5))+
    labs(x="Adipocyte Area Range (um2)",
         y="Average Adipocyte Percentage") #this shows that the KO have higher variability in size of adipocytes specifically more larger adipocytes than WT. Wt has higher density of smaller sized adipocytes
