  ...
  theme_classic() + 
   ...
   legend.position = c(0.7,0.9)) +
    labs(x="Adipocyte Area (um2)",
         y="Density",
          fill= "Maternal Genotype") #this shows that the KO have higher variabilitty in size of adipocyttes specifically more larger adipocytes than WT. Wt has higher density of smaller sized adipocytes
...
ggplot(data=percentileareabymouse, 
  ...
  theme_classic() + 
    ...
    labs(x="Adipocyte Area Range (um2)",
         y="Percent of Adipocytes",
         fill= "Maternal Genotype")#this shows that the KO have higher variability in size of adipocytes specifically more larger adipocytes than WT. Wt has higher density of smaller sized adipocytes
