...
(-0.1123 + 0.0481 *16) /0.3426 #-1.92 grams more for KO, p=0.21 this is from tthe pnbw.lme summary
...
## The effect size is 0.136*16= 2.176 grams additional weight gain over 16 days postnatal for KO dams compared to WT. This is a significant effect with p-value <0.001

(-0.0829 +  0.0727  *16) / (-0.0190 -0.0633 *16)  #-1.05 grams more for KO, p=0.21 this is from tthe pnbw.lme summary

# (-0.0190 -0.0633 *16) tthis is lost 1g for WT
(-0.0829 +  0.0727  *16) - (-0.0190 -0.0633 *16)

(-0.0190 -0.0633 *16) -0.0829 +0.0727 *16 #KO gaining 0.0485g

(-0.0190 -0.0633 *16) -((-0.0190 -0.0633 *16) -0.0829 +0.0727 *16) #-1.08 and p-value -1.7e-07
```
...
## The effect size is -0.245*16= -3.92 grams additional lean mass loss over 16 days postnatal for KO dams compared to WT. This is not a significant effect with p-value= 0.860
```
...
17.974 +2.489*16 #W eating 57.8g over 16 days
17.974 +2.489*16 + (30.738 -2.772*16 ) # KO eating 44.2 grams of food more over 16 days
