...
##This is a significant effect with p-value <0.001
 ...
 (-0.0190 -0.0633 *16) #this is lost -1.03g for WT, WT equation

(-0.0190 -0.0633 *16) + (-0.0829+ 0.0727*16) #KO are gaining on average 0.0485 grams over 16 d postnatal
  
(-0.0190 -0.0633 *16) -0.0829 +0.0727 *16 #KO gaining 0.0485g, KO equation

((-0.0190 -0.0633 *16) -0.0829 +0.0727 *16) + (-0.0190 -0.0633 *16) # =1.08 and p-value<0.001 (1.7e-07); this is the effect size 1.08g ,KOequation -WT equation, so KO are gaining 1 g more than WT over 16 days postnatal
```
...
##This is a significant effect with p-value = 0.035

17.974 +2.489*16 #WT eating 57.8g over 16 days
30.738 +(-2.772*16)# KO formula =-13.6g
