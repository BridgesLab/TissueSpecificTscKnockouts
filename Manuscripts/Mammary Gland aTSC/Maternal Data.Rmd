...
maternal.weights <-
  ...
  ggplot(data=maternal.weights, 
      aes(y=BW,
           x=DayfromDelivery,na.rm= T ,
           col= MaternalGenotype,na.rm =T, ymin=15, ymax=40, xmin=-21, xmax= 21))+
...
maternal.weights <-
  ...
  ggplot(data=deltaFatchangefromdelivery,
         aes(y=Fat.Lact,
             x=DayfromDelivery,
             col=MaternalGenotype,na.rm =T, ymin=-3, ymax=3, xmin=0, xmax= 21))+
...
maternal.weights <-
  ...
  ggplot(data=maternal.weights, 
      aes(y=Lean,
           x=DayfromDelivery,
           col=MaternalGenotype,na.rm= T ,
           ymin=10, ymax=30, xmin=-21, xmax= 21))+
       scale_x_continuous(breaks=seq(-26,16,2)) +
  ...
  ggplot(data=deltaLeanchangefromdelivery,
         aes(y=Lean.Lact,
             x=DayfromDelivery,
             col=MaternalGenotype,na.rm =T, ymin=-3, ymax=6, xmin=0, xmax= 21))+
       scale_x_continuous(breaks=seq(0,21,1)) +
    expand_limits(y=0)+
  geom_point() +
      geom_smooth ()  +
