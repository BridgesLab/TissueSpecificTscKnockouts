...
#Effect size: RMG= (0.607-0.503)/0.503 *100 = 20.68% less mass in KO
#Effect size: LMG= (0.618-0.48)/0.48 *100 = 28.75% less mass in KO
...
p <- ggplot(gland.mouse.weight %>% filter(Gland %in% c('RMGland', 'LMGland', "Weight'")),
            aes(x=Gland, y=GlandWeight, color=Genotype))+ 
...
gland.mouse.weight %>% 
    ...
    mutate(Gland= fct_recode(as.factor(Gland), "Right Lower MG"= "RMGland", "Left Lower MG"= "LMGland")) %>%
