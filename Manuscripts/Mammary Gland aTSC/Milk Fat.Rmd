...
library(ggplot2)
  ...
  geom_errorbar(width=0.5, aes(ymin = Average.Fat.Percent - SE.Average.Fat.Percent,
...
#graph per genotype 
  ...
  geom_point() +
      geom_bar(stat='identity') +
  geom_errorbar(width=0.5, aes(    ymin = Average.Fat - SE.Average.Fat,
...
lm(Average.Fat.Percent ~ Genotype + as.factor(Batch), data=milk.fat.averagepersample) %>% summary
