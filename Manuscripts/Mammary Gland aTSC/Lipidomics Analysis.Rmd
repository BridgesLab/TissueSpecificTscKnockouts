...
#Barplot SFA%
ggplot(sfamufapufa.percentage,
       aes(x=Genotype, y=Average.sfa, fill=Genotype))+
  geom_bar(position= "dodge", stat='identity') +
   geom_errorbar(width=0.5, aes(ymin=Average.sfa - SE.Average.sfa, ymax=Average.sfa + SE.Average.sfa))+
...
ggplot(sfamufapufa.percentage, is.na=NA,
       aes(x=`Genotype`, y=Average.mufa, fill=`Genotype`))+
 geom_bar(position= "dodge", stat='identity') +
   geom_errorbar(width=0.5, aes(ymin=Average.mufa - SE.Average.mufa, ymax=Average.mufa + SE.Average.mufa))+
  theme_classic() +
  expand_limits(y=0)+
...
#Barplot PUFA%
ggplot(sfamufapufa.percentage, is.na=NA,
       aes(x=`Genotype`, y=Average.pufa, fill=`Genotype`))+
 geom_bar(position= "dodge", stat='identity') +
   geom_errorbar(width=0.5,aes(ymin=Average.pufa - SE.Average.pufa, ymax=Average.pufa + SE.Average.pufa))+
  theme_classic() +
  expand_limits(y=0)+
...
ggplot(mufasfaratio, is.na=NA,
       aes(x=`Genotype`, y=Average.ratio, fill=`Genotype`))+
 geom_bar(position= "dodge", stat='identity') +
   geom_errorbar(width=0.5,aes(ymin=Average.ratio - SE.Average.ratio, ymax=Average.ratio + SE.Average.ratio))+
  theme_classic() +
  expand_limits(y=0)+
...
ggplot(sumLCFA, is.na=NA,
       aes(x=`Genotype`, y=Average.lcfa, fill=`Genotype`))+
 geom_bar(position= "dodge", stat='identity') +
   geom_errorbar(width=0.5,aes(ymin=Average.lcfa - SE.Average.lcfa, ymax=Average.lcfa + SE.Average.lcfa))+
  theme_classic() +
  expand_limits(y=0)+
 ...
 scale_fill_grey() +
    ...
    theme(text=element_text(size=18),
          axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1),
          legend.position = c(0.5,0.2)) +
    labs(y="Average Sum of LCFA (n mol)",
         x="Maternal Genotype")
...
ggplot(percent184, is.na=NA,
 ...
 geom_bar(position= "dodge", stat= "identity")+
  ...
  theme_classic() +
  expand_limits(y=0)+
  #labs(x="Genotype", y="Average Percent of 18:4",title="Average %18:4 of milk by Genotype")
   scale_fill_grey() +
    scale_color_grey() +
    theme_classic() +
    theme(text=element_text(size=18),
...
ggplot(n6n3ratio, is.na=NA,
       aes(x=Genotype, y=Average.omegaratio, fill=Genotype))+
  geom_bar(position = "dodge", stat = "identity")+
   geom_errorbar(width=0.5,aes(ymin=Average.omegaratio - SE.Average.omegaratio, ymax=Average.omegaratio + SE.Average.omegaratio))+
  theme_classic() +
  expand_limits(y=0)+
...
ggplot(n6n3.percentage, is.na=NA,
       aes(x=Genotype, y=Average.n3, fill=Genotype))+
  geom_bar(position = "dodge", stat = "identity")+
   geom_errorbar(width=0.5,aes(ymin=Average.n3 - SE.Average.n3, ymax=Average.n3 + SE.Average.n3))+
...
ggplot(n6n3.percentage, is.na=NA,
       aes(x=Genotype, y=Average.n6, fill=Genotype))+
  geom_bar(position = "dodge", stat = "identity")+
   geom_errorbar(width=0.5,aes(ymin=Average.n6 - SE.Average.n6, ymax=Average.n6 + SE.Average.n6))+
    #facet_grid(~`Ethnic Group`) +
  theme_classic() +
  expand_limits(y=0)+
...
ggplot(ALA, is.na=NA,
       aes(x=Genotype, y=Average.n3percent, fill=Genotype))+
  geom_bar(position = "dodge", stat = "identity")+
   geom_errorbar(width=0.5,aes(ymin=Average.n3percent - SE.Average.n3percent, ymax=Average.n3percent + SE.Average.n3percent))+
  theme_classic() +
  expand_limits(y=0)+
...
lipidomics.data %>%
  group_by(Genotype) %>%
  summarise_at(.vars=vars(starts_with('%'),`MUFA/SFA`,`Ratio n6/n3`),
               .funs=list(mean=mean,se=se)) %>%
  pivot_longer(!Genotype, names_to=c('Lipid','Statistic'), names_sep="_") %>%
  pivot_wider(names_from=c('Genotype','Statistic'), names_sep="_", values_from='value') %>%
  mutate(Percent.Change = KO_mean/WT_mean*100) %>%
  full_join(select(summary.stats, Lipid, Test,P.Value,Sig)) %>% 
    write_csv("Summary Table of Lipidomics Data.csv") #supplemental figure
