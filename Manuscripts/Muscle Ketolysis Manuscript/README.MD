...
| ------ | ------ | ------ |
| Figure 1A | RNAseq/scripts/barplots.Rmd | ketosis_muscle-barplot-1.pdf |
| Figure 1B | Mouse Data/Muscle Tsc1 Knockout/Ketone Tolerance/Ketone Tolerance Tests.Rmd | ktt-lineplot-2.pdf |
| Figure 1C | Mouse Data/Muscle Tsc1 Knockout/Ketone Tolerance/Ketone Tolerance Tests.Rmd | ketone-tolerance-auc-1.pdf |
