...
DO.Data %>%
  ...
  select(ID,B_AUC.bl,F_AUC.bl,AUC.change,BW3,Weight.Gain,Cholesterol.Baseline,Cholesterol.Followup,Cholesterol.Difference,TG.Baseline,	TG.Followup) %>%
  mutate("Change in Triglycerides"=TG.Followup-TG.Baseline) %>%
  rename("Baseline KTT"="B_AUC.bl",
         "Followup KTT"="F_AUC.bl",
         "Change in KTT"="AUC.change",
         "Baseline Weight"="BW3",
         "Weight Gain"="Weight.Gain",
         "Baseline Cholesterol"="Cholesterol.Baseline",
         "Followup Cholestrol"="Cholesterol.Followup",
         "Change in Cholesterol"="Cholesterol.Difference",
         "Baseline Triglycerides"="TG.Baseline",
         "Folowup Triglycerides"="TG.Followup") -> KTT.data.all
...
library(corrplot)
cor.matrix <- cor(KTT.matrix,use="all.obs")[1:3,4:11]
