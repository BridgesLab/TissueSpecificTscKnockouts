...
DO.Data %>%
  ...
  select(ID,B_AUC.bl,F_AUC.bl,AUC.change,BW3,Weight.Gain,Cholesterol.Baseline,Cholesterol.Followup,Cholesterol.Difference) %>%
  rename("Baseline KTT"="B_AUC.bl",
         ...
         "Change in Cholesterol"="Cholesterol.Difference") -> KTT.data.all
