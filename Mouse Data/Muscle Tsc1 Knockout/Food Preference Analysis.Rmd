...
ggplot(data=summary.data.all,
  ...
  geom_errorbar(position=position_dodge(width=0.75),aes(group=Genotype,
                                                        ymin=Preference-Preference.Error,
                                                        ymax=Preference+Preference.Error), width=0.5) +
  expand_limits(y=0) +
  geom_hline(yintercept=1, lty=2) +
  labs(title="Diet Preference",
...
ggplot(data=summary.data.all,
  ...
  geom_errorbar(position=position_dodge(width=0.75),aes(group=Genotype,
                                                        ...
                                                        ymax=Percent+Percent.Error), width=0.5) +
  expand_limits(y=0) +
  labs(title="Diet Preference",
...
ggplot(data=summary.data.all %>% filter(Genotype == 'fl/fl;+/+'),
       aes(y=Preference,
           x=Sex)) +
  geom_bar(stat='identity', position='dodge', width=0.75) +
  geom_errorbar(position=position_dodge(width=0.75), width=0.5, aes(ymin=Preference-Preference.Error,ymax=Preference+Preference.Error)) +
  expand_limits(y=0) +
  geom_hline(yintercept=1, lty=2) +
  labs(title="Diet Preference",
       y="Relative Preference of KD")
