...
sample.results %>%
  ...
  geom_errorbar(position=position_dodge(width=0.75),width=0.5) -> bdh1.barplot
bdh1.barplot
```
...
sample.results %>%
  ...
  ggplot(aes(y=Mean,
             ...
             fill=Diet)) +
  geom_bar(stat='identity',position="dodge",width=0.75) +
  geom_errorbar(position=position_dodge(width=0.75),width=0.5) -> hmgcs2.barplot
...
sample.results %>%
  ...
  ggplot(aes(y=Mean,
             ...
             fill=Diet)) +
  geom_bar(stat='identity',position="dodge",width=0.75) +
  geom_errorbar(position=position_dodge(width=0.75),width=0.5) -> hmgcl.barplot

hmgcl.barplot
```
## Combined Plots

```{r liver-plots-combined}
library(gridExtra)
