...
mapping$Genotype <- relevel(as.factor(mapping$Genotype), ref="Wild-Type")
...
genes.of.interest <- c("Tsc1",'Tsc2','Ppp1r3c','Cd36','Fabp3','Ucp3','Map3k9','Ppp1r15a','Slc38a1','Fgf21','Sln','Pln','Gdf15','Inha',"Mat2a",'Atf4','Trit1')
...
creatine_kinase <- c('Cka','Ckb','Ckm','Ckmt1','Ckmt2','Slc6a8','Gatm','Gamt')
...
mitofusins <- c('Mfn1','Mfn2','Opa1','Mgm1','Drp1','Dnm1')
...
bcaa <- c('Bckdha','Bckdhb','Bcat1','Bcat2','Bckdk','Ppm1k')
glo <- c('Glo1','Glo2')
atf4_related <- c('Atf4','Eif2b1','Eif2b2','Cebpa','Cebpb','Cebpd','Cebpg','Maf','Gadd45a','Cdkn1a')
atf4_muscle <- c('Gadd45a','Cdkn1a','Gdf15','Slc7a5','Slc38a2','Slc6a9', 'Aars', 'Iars', 'Nars', 'Lars', 'Sars', 'Mars', 'Cars', 'Yars', 'Tars','Trib3','Atf3','Atf5','Ddit3')
atf4_muscle_metabolic <- c('Got1','Gpt2','Mthfd2','Aldh18a1','Aldh1l2','Gpx1','Mgstl1','Eifebp1', 'Eif2s2','Eif3c','Grb10', 'Nurp1','Herpudl', 'Igfbp7','Arhgef2','Vegfa','Cebpg','Atf5','Fgf21')
atf4_targets <- c('Gadd45a','Cdkn1a','Grb10','Gdf15','Slc7a5','Lars','Nars','Sars','Ddit3','Hspa5')
gene.data.name <- c('tsc_isoforms','glycogen_genes','pp1_regulatory_subunits','interleukins','srebp','linoleate_metabolism','myokines','tg_synthesis','lipolysis','oglnac_metabolisn','ribosomes','ppar_isoforms','b_oxidation','ppard_targets','myosin_heavy_chain','myosin_heavy_chain_main','slow_twitch_genes','fast_twitch_genes','myotubular_degradation','muscle_differentiation','autophagy','mitochondrial_genes','fatty_acid_uptake','fatty_acid_uptake_no_FABP3','fabp_cd36','cb_receptors','oxidative_markers_rosenbaum','serca','uncouplers','Jnk_related_genes','aa_transporters','aa_transporters_up','jnk_activators','hippo','guridi_genes','guridi_genes_2','FGF21_related','MitochondrialCalcium_genes','mitofusins','ca_reuptake','er_stress','irx_genes','ketosis_muscle','ketone_body_generation','ketosis_receptors','pfk_2_isoforms','er_stress_select','gdf_isoforms','tgf_beta_superfamily','fiber_markers','sln','bcaa','glo','atf4_related','atf4_muscle','atf4_muscle_metabolic','atf4_targets','creatine_kinase')
